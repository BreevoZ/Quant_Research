...
EOF
    ...
    # 创建配置文件模板
    cat > "$PACK_PATH/config/config.example.ini" << 'EOF'
# LOB数据处理程序配置文件
...
[paths]
lob_base = /home/sharedriver1/public/Lob_local
level2_base = /home/sharedriver1/public/Level2
csv_output = /home/sharedriver1/public/Lob_local_1s
...
注意:
  1. 首次运行前请修改 config/config.example.ini 中的配置
