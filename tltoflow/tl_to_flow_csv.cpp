...
constexpr const char* kDefaultTlRoot = "/home/TLData";
constexpr const char* kDefaultOutputRoot = "/home/sharedriver1/public/Flow_TL";
...
struct Options {
    ...
    std::string end_time;
    std::string tl_root = kDefaultTlRoot;
...
static void print_help(const char* argv0) {
    std::cerr
        ...
        << "  --tl-root DIR                    default TL root (default: /home/TLData)\n"
        << "  --output-root DIR                default output root (default: /home/sharedriver1/public/Flow_TL)\n"
