...
#   3) merge_action_parquet.py 合并当日全市场 -> /home/sharedriver1/public/Level2_MX/<date>_auction.parquet
#
...
tl_base_dir="/home/TLData"

# 路径: cpp 上一级即 action_data_save 项目根
...
staging_dir="/home/sharedriver1/public/Level2_MX/.auction"
merge_script="$project_dir/merge_action_parquet.py"
parquet_out_dir="/home/sharedriver1/public/Level2_MX"   # 当日 parquet: <date>_auction.parquet
...
do
    ...
    ./build/auction_lob_main -d "$current_date" -w "$workers" -f "$tl_base_dir" -o "$staging_dir"
    if [ $? -ne 0 ]; then
